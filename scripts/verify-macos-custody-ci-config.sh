...
require_literal '-p pm-native-channel -p pm-vault -p pm-crypto -p pm-custody -p pm-sync --locked --offline' "$lab"
...
require_literal 'agent-attempt' "$harness"
require_literal 'wait_selected_access_row' "$harness"
require_literal 'ticket24-macos-pending-canary' "$harness"
require_literal 'wait_stable_reveal_expiry' "$harness"
...
require_literal 'run_tui_ticket23_matrix(' "$harness"
require_literal 'run_tui_ticket24_matrix(' "$harness"
