...
pub use root::{
    AuditDeviceKeyPair, AuditKey, AuditKeyPackage, CreatedRoot, CryptoError, DeviceKeyPair,
    GrantVectorInput, ItemKind, KdfProfile, OpenedRevisionPackage, PendingGrantVector, Pmf1Vector,
    RecoveryCode, RevisionPackage, RevisionPackageInput, RootBundle, SignedGrantVector,
    TrustedRoot, UnlockedRoot, create_human_root, digest, open_human_root, random_id,
    recover_human_root, verify_audit_signature, verify_human_command, verify_human_event,
};
