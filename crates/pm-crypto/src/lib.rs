...
pub use root::{
    AuditCiphertext, CreatedRoot, CryptoError, DeviceKeyPair, DigestState, FileCiphertext,
    ...
    fill_random, open_human_root, random_id, recover_human_root, verify_human_command,
    verify_human_event,
};
