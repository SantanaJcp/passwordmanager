...
Publicación pausada desde el push ordinario de `01a74a7`: GitHub aceptó la actualización mediante la excepción de administrador, pero anunció una violación de protección. La consulta de solo lectura confirmó el ruleset activo `main` (ID 23168096) con `~ALL`, que bloquea creación/actualización de todas las ramas, incluida la del PR. No se cambiaron reglas ni se usó force push; no repetir pushes hasta aclarar con el usuario el alcance de esa protección. La implementación local sigue autorizada.
