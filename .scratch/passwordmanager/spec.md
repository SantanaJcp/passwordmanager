...
**Ejecución posterior autorizada (2026-09-13):** ya existen código, build reproducible y evidencia de laboratorio Linux x86_64. La tabla mantiene las puertas de validación integral, no afirma que toda prueba siga sin ejecutar. El estado de cada entrega y sus comandos/resultados está en los [tickets](issues/README.md) y [registro de ejecución](execution.md); las selecciones documentales no equivalen a certificación nativa o de seguridad.
...
### 15.4 Registro histórico de preparación y siguiente fase (2026-09-12)
...
- [G3: perfiles concretos y resolución B1–B4](../../docs/research/g3-authentication-integrations.md): cierre documental de perfiles; evidencia parcial P1–P4 y adversaria P5 enlazada en §15.2, matriz integral y certificación pendientes.
